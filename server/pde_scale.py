...
for zpde in [0.0, 0.001, 0.01, 0.05, 0.1]:
    gen = entrodiff_heun_sampler(model, shape, 0.002, math.sqrt(2*nu*tau_max),
                                  tau_max, nu, num_steps=50, device=device, zeta_pde=zpde)
