...
% ============================================================================
\subsection{Stage 3: Kruzhkov Entropy Solution $L^1$ Contraction Framework}\label{sec:stage3}
...
\subsubsection{3.1 Kruzhkov Entropy Condition and $L^1$ Contraction}
...
% ============================================================================
\subsection{Stage 4: Assembly of the Wasserstein Error and Emergence of $\mathcal{O}(\varepsilon^{1/2})$}\label{sec:stage4}
...
% ============================================================================
\subsection*{Appendix A: Symbol Correspondence Table (Old $\to$ Revised)}
